    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 column">
                ...
                <asp:Button ID="btnLogin" runat="server" meta:resourcekey="btnLoginResource1" Text="Login" />
                <asp:Label ID="lblErr" runat="server" CssClass="auto-style22" meta:resourcekey="lblErrResource1" Text="Err!" Visible="False"></asp:Label>
                <asp:Button ID="btnForget" runat="server" meta:resourcekey="btnForgetResource1" Text="If you forget your password clik here." />
            </div>
        </div>
    </div>
</asp:Content>
